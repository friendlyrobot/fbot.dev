  ...
  const services = [
    {
      ...
      description:
        "Build exactly what your business needs, nothing more, nothing less",
    },
    {
      icon: Globe,
      title: "Web Applications",
      description:
        "Online platforms that work smoothly and make sense to your users",
    },
    {
      icon: Smartphone,
      title: "Mobile Apps",
      description:
        "Apps people actually want to use, designed for real-world problems",
    },
    {
      icon: LinkIcon,
    ...
    },
    {
      ...
      description:
        "Honest advice about what tech will actually help your business",
    },
    {
      icon: Zap,
      title: "MVP Development",
      description:
        "Build high quality prototypes to test your idea with real customers",
    },
  ];
