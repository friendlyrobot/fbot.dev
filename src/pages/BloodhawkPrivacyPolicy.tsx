      ...
      <div className="bg-white dark:bg-gray-900">
        <div className="prose prose-lg dark:prose-invert max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
          ...
          <p>
            ...
            use, and protect your information when you use our mobile
            application.
          </p>
          <p>
          ...
          <ul>
            <li>
              ...
              processing is complete. The analysis is performed in memory, and
              the results are sent directly back to your device.
            </li>
          </ul>
          <h3 className="mt-8 text-xl font-semibold text-gray-900 dark:text-white">
          ...
          <ul>
            <li>
              ...
              ID is not linked to your real-world identity and is used to
              provide a continuous experience and manage your usage limits.
            </li>
            <li>
              <strong>Usage Data:</strong> We collect information about your
              usage of the app, such as the number of uploads you perform. This
              data is associated with your anonymous user ID and helps us manage
              our service and enforce usage limits. This includes:
              <ul>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <strong>Interactions:</strong> Actions you take, such as
                  tapping buttons or using features.
                </li>
                <li>
              ...
              All analytics data is associated with your anonymous user ID. We
              do not track any Personally Identifiable Information (PII) or
              sensitive health data in our analytics.
            </li>
          </ul>
          <h2 className="mt-12 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <ul>
            ...
            <li>
              ...
              required by law, such as in response to a subpoena, court order,
          ...
          <ul>
            <li>
              <strong>On-Device Storage:</strong> Your analysis results are
              stored locally on your device. You have full control over this
              data and can delete it at any time through the app's settings.
            </li>
            <li>
          ...
          <ul>
            <li>
              <strong>Clearing Data:</strong> You can clear all your stored
              blood test data from your device at any time from the "Profile &
              Settings" screen in the app.
            </li>
            <li>
              <strong>Analytics:</strong> While we do not offer an opt-out for
              analytics at this time, we are committed to collecting only the
              data necessary to improve our service and ensuring it remains
              anonymous.
            </li>
          </ul>
          <h2 className="mt-12 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
